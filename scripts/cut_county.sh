...
#
# 示例:
#   bash scripts/cut_county.sh 天台县 /Users/tianli/Work/shared/resources/gis/derived/county-slices/台州市/天台县
...
示例:
  $0 天台县 /Users/tianli/Work/shared/resources/gis/derived/county-slices/台州市/天台县
