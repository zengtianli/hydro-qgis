...
COUNTY_SLICE_CITY_OVERRIDES = {
    "台州市": {
        ...
        "河道": {
            "source": f"{RESOURCES_GIS_RAW}/city-sources/台州市.gdb|layername=RVAA",
        ...
        "湖泊": {
            "source": f"{RESOURCES_GIS_RAW}/city-sources/台州市.gdb|layername=LKAA",
            "source_crs": "EPSG:4528",
            "method": "attr_filter",
            "attr_filter": "COUNTY LIKE '%{county}%'",
            "geom_type": "Polygon",
        ...
        "水库": {
            "source": f"{RESOURCES_GIS_RAW}/city-sources/台州市.gdb|layername=RSAA",
            "source_crs": "EPSG:4528",
            "method": "attr_filter",
            "attr_filter": "COUNTY LIKE '%{county}%'",
            "geom_type": "Polygon",
        ...
        "山塘": {
            "source": f"{RESOURCES_GIS_RAW}/city-sources/台州市.gdb|layername=HPAA",
            "source_crs": "EPSG:4528",
            "method": "attr_filter",
            "attr_filter": "COUNTY LIKE '%{county}%'",
            "geom_type": "Polygon",
        ...
        "渠道": {
            "source": f"{RESOURCES_GIS_RAW}/city-sources/台州市.gdb|layername=ACAA",
            "source_crs": "EPSG:4528",
            "method": "attr_filter",
            "attr_filter": "COUNTY LIKE '%{county}%'",
            "geom_type": "Polygon",
        ...
        "海域": {
            "source": f"{RESOURCES_GIS_RAW}/city-sources/台州市.gdb|layername=OWAA",
            "source_crs": "EPSG:4528",
            "method": "attr_filter",
            "attr_filter": "COUNTY LIKE '%{county}%'",
            "geom_type": "Polygon",
